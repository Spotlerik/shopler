// Auto-generated mirror of use_cases.json (single source of truth, copied from
// github.com/Spotlerik/usecases-ecom). Loaded as a <script> so the hidden use-case
// demo pages read it without fetch() (works on file:// and under the /shopler/ subpath).
// Do not hand-edit — re-copy use_cases.json and regenerate.
window.USE_CASES = [
  {
    "id": "email-capture",
    "number": 1,
